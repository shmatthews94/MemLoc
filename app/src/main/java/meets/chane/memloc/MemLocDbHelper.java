...
public class MemLocDbHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "MemLoc.db";
    ...
    public void addReminder(SQLiteDatabase db, String task, String loc, String lat, String lon) {
        db.execSQL("INSERT INTO Reminders VALUES('"+task+"','"+loc+
                "','"+lat+"','"+lon+"');");
